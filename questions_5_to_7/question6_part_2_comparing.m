...
clf
loglog([2,4,8,16,32], rel_error_cubic_zero, 'DisplayName', "T0 = Cubic, u = Zero");
hold on
loglog([2,4,8,16,32], rel_error_cubic_sines, 'DisplayName', "T0 = Cubic, u = Sines");
hold on
loglog([2,4,8,16,32], rel_error_Jump_zero, 'DisplayName', "T0 = Jump, u = Zero");
hold on
loglog([2,4,8,16,32], rel_error_Jump_Sines, 'DisplayName', "T0 = Jump, u = Sines");
hold off
legend()
...
clf
loglog([2,4,8,16,32], abs_error_cubic_zero, 'DisplayName', "T0 = Cubic, u = Zero");
hold on
loglog([2,4,8,16,32], abs_error_cubic_sines, 'DisplayName', "T0 = Cubic, u = Sines");
hold on
loglog([2,4,8,16,32], abs_error_Jump_zero, 'DisplayName', "T0 = Jump, u = Zero");
hold on
loglog([2,4,8,16,32], abs_error_Jump_Sines, 'DisplayName', "T0 = Jump, u = Sines");
hold off
legend()
